...
void UI::particleSystemWindow() {
	if (particleSystemFlag) {
		...
		ImGui::DragInt("Max Particles", &instance->particleSystem->max_particles, 1, 1, 1000);
		ImGui::DragInt("Particles per Spawn", &instance->particleSystem->particles_per_spawn, 1, 1, 100);
		ImGui::DragFloat("Spawn Radius", &instance->particleSystem->spawn_radius, 0.1, 1, 1000);
		ImGui::DragFloat("Time Between Spawn", &instance->particleSystem->time_between_spawn, 0.01, 0.01, 10); 
		ImGui::DragFloat("Particle Speed", &instance->particleSystem->particle_speed, 0.1, 1, 100);
